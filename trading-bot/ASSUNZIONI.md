...
| `SHORT_TERM_MIN_SHARES` | 0 (spento) | **M** | Sotto 4 azioni la scala di uscita non è eseguibile (aritmetica). Ma **misurato e respinto**: in campione migliora tutto, fuori campione il drawdown peggiora di 8,1 punti. Il rimedio fa più danni del difetto. Il candidato sotto soglia resta segnalato nel report |
...
| `SHORT_TERM_TRAILING_ATR_MULT` | 0.0 (spento) | **M** | Testato contro 2, 3 e 4, in campione e fuori. Sui totali migliora tutto, ma fuori campione vince solo in **8 anni su 16**: spento per scelta dell'utente, anche perché è una modifica contro il corso. Si riaccende con `=3` |
